    ...
    <div>
        ...
        <el-card shadow="never" style="margin-top: 20px;text-align: center">
            <div v-if="!token" style="font-size: 0.9rem;line-height: 1.5;color: #606c71;">
                <el-tag type="danger" size="small">&nbsp;</el-tag>&nbsp;&nbsp; 未登录&nbsp;&nbsp;
                <el-button type="text" @click="openTokenDialog">登陆</el-button>
            </div>
            <div v-if="token" style="font-size: 0.9rem;line-height: 1.5;color: #303133;">
                <el-tag type="success" size="small">&nbsp;</el-tag>&nbsp;&nbsp; 已登录&nbsp;&nbsp;
                <el-button type="text" @click="cancellation">注销</el-button>
            </div>
            <!--<div style="margin-top: 10px;text-align: left">-->
                <!--<el-alert title="Token获取" type="info" description="用户名为github账号,在 github-> settings-> developerSettings-> personalAccessTokens 勾选gist权限,获取Token"-->
                    <!--:closable="false">-->
                <!--</el-alert>-->
            <!--</div>-->
        </el-card>
